...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a onclick="location.href='<%= request.getContextPath() %>/student/questionlist'" class="nav-link active" data-toggle="tab" >작성글</a>
  </li>
  <li class="nav-item">
    <a id="write" onclick="location.href='<%= request.getContextPath() %>/student/questioncommlist'" class="nav-link" data-toggle="tab" >작성댓글</a>
  </li>
</ul>
