...
<!-- 			<img src="/examples/images/avatar.png" alt="Avatar"> -->
        ...
        <label><input type="radio" name="who"/> 학생</label>&emsp;
        <label><input type="radio" name="who"/> 선생님</label>
...
<!--             <label class="float-left form-check-label"><input type="checkbox"> 아이디 저장</label> -->
            <a href="findpw.jsp" class="float-right">비밀번호 찾기</a>
            <span class="bar" aria-hidden="true"> | </span>
            <a href="findid.jsp" class="float-right">아이디 찾기</a>
        </div>
        <div class="or-seperator"></div>
        <div class="text-center social-btn" >
            <a href="#" class="btn btn-primary btn-lg btn-block"><i class="fa fa-facebook"></i> <b>Facebook</b> 로그인 </a>
            <a href="#" class="btn btn-info btn-lg btn-block"><i class="fa fa-twitter"></i> <b>Twitter</b> 로그인 </a>
