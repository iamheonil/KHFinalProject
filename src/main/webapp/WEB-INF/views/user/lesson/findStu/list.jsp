		        ...
		        <div class="col-sm-6">
		                <div class="panel-body p-t-10">
		                    <div class="media-main">
		                            ...
		                            <h4><a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="#" data-original-title="Message"><i class="glyphicon glyphicon-envelope" id="message" style="color: #17B794;"></i></a>&nbsp;${findstu.USER_ID }</h4>
		                            <p class="text-muted">
