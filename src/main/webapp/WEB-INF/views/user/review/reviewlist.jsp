...
//         console.log(noteDesc)
    ...
    //모달이 닫히면서 실행되는 함수 - 모달 내용 초기화 - 새로고침 된 이후에는 필요없을듯 - ㄴㄴ작성하다가 취소했을 때 필요함
		                                ...
		                                <div class="row">
		                                    ...
		                                    <div class="col-md-12">
		                                        <div class="modal-description">
		                                            <label>내용</label>
		                                            <textarea id="note-has-description" name="modal-desc" class="form-control" minlength="60" rows="3" 
