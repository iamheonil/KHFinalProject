...
<div id="main">
	...
	<div id="profileborder">
				...
				<div class="modal-dialog vertical-align-center">
					<div class="modal-content panel-info" >
						...
						<div class="modal-header panel heading">
							<h4 class="modal-title" id="myMoalLabel">회원 탈퇴 안내</h4>
						</div>

						<div class="modal-body">
							1. 연결된 과외가 있는 경우 회원탈퇴를 할 수 없습니다.<br> 2. 회원탈퇴시 모든 거래내역은 확인할 수
							없습니다.<br> 3. 회원탈퇴시 결제 이미 결제된 과외 글에 대해서 환불할 수 없습니다<br>
							4. 학생의 정보를 다시 열람 할 수 없습니다<br> 5. 위의 사항을 모두 동의합니다<br>
						</div>

						<div class="modal-footer">
							<button type="button" class="btn btn-default"
								data-dismiss="modal">취소</button>
							<a href="<%= request.getContextPath() %>/teacher/profile/delete"><button
									type="button" class="btn btn-default">탈퇴하기</button></a>
						</div>
		...
		<form action="<%= request.getContextPath() %>/teacher/profile/update"
			method="post" class="form-horizontal" enctype="multipart/form-data">

			<div class="boardersize pointfont">
				<h5>개인 정보</h5>
			</div>
			...
			<div class="boardersize">
				...
				<div>
					<img class="imgsize" alt="teacherFile"
						src="<%= request.getContextPath() %>/resources/upload/${teacherFile.tchFileRename }">
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<div class="col-8 float">
					<input type="text" id="userId" name="userId" size="20"
						readonly="readonly" value="${loginUser.userId }">
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<div class="col-8 float">
					<input type="password" class="form-control" id="userPw"
						name="userPw" size="20" autofocus="autofocus">
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<div class="col-8 float">
					<input type="password" class="form-control" id="userPw_check"
						name="userPw_check" size="20">
				</div>
			</div>
			...
			<div class="boardersize">
				<div id="pw-check" style="font-size: 8px;">
					<span id="pw-check-msg" class="pw-check-msg"
						style="font-size: 8px; text-align: center;" size="20"></span>
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<div class="col-8 float">
					<input type="email" class="form-control" name="userEmail"
						readonly="readonly" size="20" value="${loginUser.userEmail }" />
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<div class="col-8 float">
					<input type="text" class="form-control"
						onKeyup="inputPhoneNumber(this);" maxlength="13" name="userPhone"
						size="20" value="${loginUser.userPhone }">
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<div class="col-8 float">
					...
					<input type="text" id="postCode" name="postCode" placeholder="우편번호"
						size="20" value="${loginUser.postCode }"><br> <input
						type="text" id="roadAddress" name="roadAddress"
						placeholder="도로명주소" size="35" value="${loginUser.roadAddress }"><br>
					<input type="text" id="detailAddress" name="detailAddress"
						placeholder="상세주소" size="35" value="${loginUser.detailAddress }"><br>
				</div>

				<div class="form-group row" id="resume"></div>
			</div>

			<div class="boardersize">
				<label class="col-form-label col-4">성별</label>
				<div class="col-8 float">
					<label><input type="radio" id="m" name="userGender"
						value="m" checked="${loginUser.userGender } == m" /> 남&emsp;&emsp;</label>
					<label><input type="radio" id="w" name="userGender"
						value="w" checked="${loginUser.userGender } == w" /> 여</label>
				</div>
			</div>
				...
				<div class="col-8 float">
					<p>
						<input type="date" name="userBirth"
							value="${loginUser.userBirth }" min="1940-01-01" max="2020-12-31" />
					</p>
				</div>
			</div>
			...
			<div class="boardersize">
				...
				<small style="color: tomato;">사진은 1장만 선택 가능하며, 기존 프로필은 자동으로
					삭제됩니다</small><br> <small>이미지 미리보기</small>
				<div id="fileView">
