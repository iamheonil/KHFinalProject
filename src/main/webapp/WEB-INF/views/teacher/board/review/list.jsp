...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a id="write" onclick="location.href='<%= request.getContextPath() %>/teacher/review/list'" class="nav-link active" data-toggle="tab" >작성된 후기</a>
  </li>
