...
public class Paging12 {
   ...
   //총 게시글 수만 입력하는 생성자
    public Paging12(int totalCount) {
    ...
    public Paging12(int totalCount,int curPage) {
       setTotalCount(totalCount);
       setCurPage(curPage);
    ...
    public Paging12(int totalCount,int curPage,int listCount) {
       setTotalCount(totalCount);
       setCurPage(curPage);
    ...
    public Paging12(int totalCount,int curPage,int listCount, int pageCount) {
       setTotalCount(totalCount);
       setCurPage(curPage);
       setListCount(listCount);
